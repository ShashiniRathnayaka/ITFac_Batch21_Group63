...
public class PlantQuantityValidationAPI {
    ...
    public PlantQuantityValidationAPI() {
    ...
    public void createPlant(int categoryId, Map<String, Object> body) {
        try {
            ...
            System.out.println("DEBUG: PlantQuantityValidationAPI status=" + statusCode);
            System.out.println("DEBUG: PlantQuantityValidationAPI body=" + responseBody);

        } catch (Exception e) {
            this.statusCode = -1;
            this.responseBody = e.toString();
            System.out.println("DEBUG: PlantQuantityValidationAPI exception: " + e.toString());
        } finally {
            if (apiRequest != null) {
                apiRequest.dispose();
            }
