...
public class PlantPriceValidationAPI {
    ...
    public PlantPriceValidationAPI() {
    ...
    public void createPlant(int categoryId, Map<String, Object> body) {
        try {
            ...
            System.out.println("DEBUG: PlantPriceValidationAPI status=" + statusCode);
            System.out.println("DEBUG: PlantPriceValidationAPI body=" + responseBody);

        } catch (Exception e) {
            this.statusCode = -1;
            this.responseBody = e.toString();
            System.out.println("DEBUG: PlantPriceValidationAPI exception: " + e.toString());
        } finally {
            if (apiRequest != null) {
                apiRequest.dispose();
            }
