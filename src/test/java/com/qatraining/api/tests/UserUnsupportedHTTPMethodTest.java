...
public class UserUnsupportedHTTPMethodTest {
    ...
    public void testUnsupportedMethodOnSales() {
        ...
        // Verify response is either 405 or 200 (depending on API implementation)
        int statusCode = lastResponse.getStatusCode();
        assertTrue(statusCode == 405 || statusCode == 200,
            "OPTIONS request to /sales should return 405 or 200, got: " + statusCode);
    }

    @Test
    @DisplayName("Verify unauthenticated PUT request returns 401 first, then 405")
    public void testUnsupportedMethodWithoutAuth() {
        ...
        // Should return 401 or 405 (401 for auth failure, 405 for method not allowed)
        int statusCode = lastResponse.getStatusCode();
        assertTrue(statusCode == 405 || statusCode == 401,
            "PUT request without auth should return 401 or 405, got: " + statusCode);
    }
}
